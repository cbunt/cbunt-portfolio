...
"use strict";(self.webpackChunkcbunt_portfolio=self.webpackChunkcbunt_portfolio||[]).push([[93],{3099:(e,r,t)=>{t.d(r,{A:()=>i});var o=t(6070),n=t(8158),a=t(8023);function i({as:e,children:r,options:{remarkPlugins:t,components:i,...s}={},...l}){const c=e??"article";return(0,o.jsx)(c,{...l,children:(0,o.jsx)(n.o,{components:{h1:"h2",h2:"h3",...i},remarkPlugins:[a.A,...t??[]],...s,children:r})})}},4867:(e,r,t)=>{t.d(r,{A:()=>pe});var o=t(6070),n=t(9969),a=t(9564),i=t(758),s=t(2620),l=t(8859);const c=(0,s.Ay)(l.A).attrs({forwardedAs:"a",defaultFilter:{disable:!0},activeFilter:{scale:7},hoverFilter:{animation:"alternating loop",scale:7}})`
...
`;var d=t(4977),h=t(8420);const u=["cubemap-blur","gltf-viewer"].map((e=>e.replaceAll("-"," "))),p=s.Ay.div`
    display: flex;
...
`;function v(){const[e,r]=(0,i.useState)(!1),[t,n]=(0,i.useState)(!1),a=(0,i.useMemo)((()=>u.map(((e,r)=>(0,o.jsx)(g,{href:`/samples/${["cubemap-blur","gltf-viewer"][r]}`,children:e},r)))),[]);return(0,o.jsxs)(p,{onMouseLeave:()=>{r(t)},children:[(0,o.jsx)(m,{onMouseDown:()=>{n((e=>!e)),r(!t||e)},onMouseEnter:()=>{r(!0)},onKeyDown:()=>{n((e=>!e)),r(!t)},children:"Samples"}),(0,o.jsxs)(f,{isOpen:e,children:[...a]})]})}const b=s.DU`
    ::-webkit-scrollbar {
        width: 10px;
        height: 10px;
...
`;function T({label:e,value:r,onChange:t=()=>{},callbacks:n,description:a}){const s=(0,i.useId)(),[l,c]=(0,i.useState)(r),d=e=>{"boolean"==typeof e&&e!==l&&c(e)};return null!=n&&(0,i.useEffect)((()=>(n.add(d),()=>{n.delete(d)}))),(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(F,{forwardedAs:"label",htmlFor:s,tooltipContent:a,children:e}),(0,o.jsx)(S,{children:(0,o.jsx)(z,{"aria-label":e,checked:l,onChange:e=>{c(e.target.checked),t(e.target.checked)},id:s})}),(0,o.jsx)("div",{})]})}const M=(0,s.Ay)(l.A).attrs({forwardedAs:"button",type:"button",defaultFilter:{disable:!0,scale:5,baseFrequency:.02,numOctaves:1},hoverFilter:{animation:"alternating loop",scale:4,baseFrequency:.01},activeFilter:{scale:5,baseFrequency:.01},distortChildren:h.cg})`
    color: var(--accent-3);
...
`,$=(0,s.Ay)(l.A).attrs({hoverFilter:{mode:"alternating loop",baseFrequency:.02,scale:6},activeFilter:{mode:"static",baseFrequency:.02,scale:6}})`
    display: flex;
`;function W({label:e,onChange:r,min:t=0,max:n=10,step:a=1,value:s=5,description:l,callbacks:c}){const d=(0,i.useId)(),[h,u]=(0,i.useState)({min:t,max:n,step:a,value:s}),p=(0,i.useRef)(null),f=e=>{let t=""!==e.target.value?parseFloat(e.target.value):h.min;t=(0,B.qE)(t,h.min,h.max),t!==h.value&&(u({...h,value:t}),r?.(t),p.current?.refreshSeed())};function m(e,r){"max"!==r&&"min"!==r&&"value"!==r&&"step"!==r||h[r]!==e&&u((t=>({...t,[r]:e})))}return null!=c&&(0,i.useEffect)((()=>(c.add(m),()=>{c.delete(m)}))),(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(F,{forwardedAs:"label",htmlFor:d,tooltipContent:l,children:e}),(0,o.jsx)($,{ref:p,children:(0,o.jsx)(R,{"aria-label":`${e}-slider`,onChange:f,...h})}),(0,o.jsx)(O,{children:(0,o.jsx)(V,{...h,id:d,"aria-label":`${e}-text-input`,onChange:f})})]})}var _=t(3357),Z=t(6460),L=t.n(Z);const G=(0,s.Ay)(d.S).attrs({elementType:"form"})`
    display: grid;
...
`;function H({children:e}){const r=(0,i.useId)(),t=(0,i.useRef)(null),n=(0,i.useRef)(null),[a,s]=(0,i.useState)(!0);return(0,o.jsx)(L(),{handle:`#${CSS.escape(r)}`,onDrag:()=>n.current?.refreshSeed(),bounds:"parent",nodeRef:t,children:(0,o.jsxs)(D,{ref:n,forwardedRef:t,children:[(0,o.jsx)(q,{id:r}),(0,o.jsxs)(X,{children:[(0,o.jsx)(Y,{children:(0,o.jsx)("input",{type:"checkbox",style:{position:"absolute",top:-9999,left:-9999},onInput:()=>{s((e=>!e))},checked:a,readOnly:!0})}),(0,o.jsx)(G,{isOpen:a,overflowOnExpanded:!0,children:e})]})]})})}const U=(0,s.Ay)(M)`
    grid-column: span 3; 
    color: var(--accent-2); 
    --border-color: var(--accent-2);
`;function Q({settings:e}){return(0,o.jsxs)(H,{children:[...Object.entries(e).map((([e,r])=>{const{[_.t.$type]:t,[_.t.$callback]:n,[_.t.$listeners]:a,...i}=r,s={...i,callbacks:a,label:e,onChange:e=>{r.value=e}};switch(r[_.t.$type]){case"button":return(0,o.jsx)(U,{...i,children:e});case"checkbox":return(0,o.jsx)(T,{...s});case"slider":return(0,o.jsx)(W,{...s});case"file":return(0,o.jsx)(N,{...s});default:throw new Error}}))]})}var J=t(3205);const K=(0,s.Ay)(l.A).attrs({forwardedAs:"button",defaultFilter:{scale:3},hoverFilter:{animation:"alternating loop",scale:7}})`
...
`;function ne({getModelConstructor:e}){const r=(0,i.useRef)(null),n=(0,i.useRef)(null),a=(0,i.useRef)(null),s=(0,i.useRef)(!1),l=(0,i.useRef)(!0),c=(0,i.useRef)(null),d=(0,i.useRef)(0),[h,u]=(0,i.useState)(null),p=e=>{if(null==a.current)return;const r=a.current,{movementX:t,movementY:o}=e;1&d.current&&r.rotate(t,o),2&d.current&&r.zoom(10*o),4&d.current&&r.pan(-t,o)},f=()=>{document.removeEventListener("mousemove",p,!1),r.current?.blur(),r.current&&(0,j.fY)(r.current),s.current&&(s.current=!1,l.current=!1,setTimeout((()=>{l.current=!0}),1500))},m=()=>{document.pointerLockElement===r.current?(s.current=!0,r.current&&(0,j.mh)(r.current,{reserveScrollBarGap:!0}),document.addEventListener("mousemove",p,!1)):f()},g=()=>{document.removeEventListener("pointerlockchange",m),s.current&&f()};(0,i.useEffect)((()=>null==r.current?()=>{}:(document.addEventListener("pointerlockchange",m,!1),null==n.current&&Promise.all([t.e(438).then(t.bind(t,1438)),e()]).then((async([e,t])=>{if(null==r.current)throw new Error("webgpu render -- canvas uninitialized");n.current=await e.default.CreateInitialized(r.current),a.current=new te(n.current.camera);const o=new t(n.current);u(o.settings),requestAnimationFrame(n.current.render)})),g)));const v=null!=h?(0,o.jsx)(Q,{settings:h}):void 0;return(0,o.jsxs)(oe,{ref:c,children:[(0,o.jsx)(ee,{element:c}),(0,o.jsx)("canvas",{ref:r,onMouseDown:e=>{d.current=7&e.buttons,l.current&&r.current?.requestPointerLock()},onMouseUp:e=>{d.current=7&e.buttons,0===d.current&&(s.current=!1,document.exitPointerLock())},onWheel:e=>{s.current&&a.current?.zoom(e.deltaY)},tabIndex:0}),v]})}const ae=s.Ay.div`
    display: flex;
    justify-content: center;
    align-items: center;
    width: 100%;
...
`,ie=(0,s.Ay)(l.A).attrs({defaultFilter:{disable:!0,scale:5},distortChildren:h.cg})`
    ...
    width: 100%;
`;function se({getModelConstructor:e}){return(0,o.jsx)(ie,{children:null==navigator.gpu?.requestAdapter?(0,o.jsx)(ae,{children:(0,o.jsxs)("p",{children:["This browser does not support webgpu.",(0,o.jsx)("br",{}),(0,o.jsx)("br",{}),"For an up to date list of supported browsers,",(0,o.jsx)("br",{}),"see"," ",(0,o.jsx)("a",{href:"https://caniuse.com/webgpu",children:"caniuse.com/webgpu"}),"."]})}):(0,o.jsx)(ne,{getModelConstructor:e})})}var le=t(7851),ce=t(895);const de=(0,le.a)({theme:"dark",settings:{background:"var(--background-color)",foreground:"var(--hi-vis-color)",caret:"red",selection:"#8884",selectionMatch:"#8880",lineHighlight:"#0000",gutterBackground:"var(--background-color)",gutterForeground:"var(--accent-3)",fontFamily:"Space Mono",fontSize:"min(2vw, 1rem)"},styles:[{tag:ce._A.propertyName,"font-style":"italic"},{tag:ce._A.literal,color:"var(--accent-3)"},{tag:[ce._A.className,ce._A.typeName],color:"var(--accent-2)"},{tag:[ce._A.string,ce._A.special(ce._A.brace)],color:"light-dark(#037b55, #c1fba0)"},{tag:ce._A.comment,color:"color-mix(in oklab, var(--background-color) 40%, var(--hi-vis-gray))"},{tag:[ce._A.keyword,ce._A.operator],color:"var(--accent-2)","font-weight":"bold"},{tag:[ce._A.brace,ce._A.bracket,ce._A.paren,ce._A.angleBracket],color:"var(--accent-3)","font-weight":"bold"},{tag:[ce._A.function(ce._A.propertyName),ce._A.function(ce._A.variableName)],color:"var(--accent-1)","font-weight":"bold"}]}),he=(0,s.Ay)(l.A).attrs({defaultFilter:{disable:!0},distortChildren:h.cg})`
    position: relative;
