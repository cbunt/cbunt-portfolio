import code from '../../rendering/samples/cubemap-blur/cubemap-guassian-pyramid.ts?raw';

export const modelName =" Cubemap Blur";
export const source = code;

export const ModelConstructor = navigator.gpu?.requestAdapter != null
    ? await import('../../rendering/samples/cubemap-blur/cubemap-blur-sample').then((m) => m.default)
    : undefined;
