...
`,ie=(0,s.Ay)(l.A).attrs({defaultFilter:{disable:!0,scale:5},distortChildren:h.cg})`
    ...
    width: 100%;
`;function se({getModelConstructor:e}){return(0,o.jsx)(ie,{children:null==navigator.gpu?.requestAdapter?(0,o.jsx)(ae,{children:(0,o.jsxs)("p",{children:["This browser does not support webgpu.",(0,o.jsx)("br",{}),(0,o.jsx)("br",{}),"For an up to date list of supported browsers,",(0,o.jsx)("br",{}),"see"," ",(0,o.jsx)("a",{href:"https://caniuse.com/webgpu",children:"caniuse.com/webgpu"}),"."]})}):(0,o.jsx)(ne,{getModelConstructor:e})})}var le=t(9135),ce=t(895);const de=(0,le.a)({theme:"dark",settings:{background:"var(--background-color)",foreground:"var(--hi-vis-color)",caret:"red",selection:"#8884",selectionMatch:"#8880",lineHighlight:"#0000",gutterBackground:"var(--background-color)",gutterForeground:"var(--accent-3)",fontFamily:"Space Mono",fontSize:"min(2vw, 1rem)"},styles:[{tag:ce._A.propertyName,"font-style":"italic"},{tag:ce._A.literal,color:"var(--accent-3)"},{tag:[ce._A.className,ce._A.typeName],color:"var(--accent-2)"},{tag:[ce._A.string,ce._A.special(ce._A.brace)],color:"light-dark(#037b55, #c1fba0)"},{tag:ce._A.comment,color:"color-mix(in oklab, var(--background-color) 40%, var(--hi-vis-gray))"},{tag:[ce._A.keyword,ce._A.operator],color:"var(--accent-2)","font-weight":"bold"},{tag:[ce._A.brace,ce._A.bracket,ce._A.paren,ce._A.angleBracket],color:"var(--accent-3)","font-weight":"bold"},{tag:[ce._A.function(ce._A.propertyName),ce._A.function(ce._A.variableName)],color:"var(--accent-1)","font-weight":"bold"}]}),he=(0,s.Ay)(l.A).attrs({defaultFilter:{disable:!0},distortChildren:h.cg})`
    position: relative;
