...
"use strict";(self.webpackChunkcbunt_portfolio=self.webpackChunkcbunt_portfolio||[]).push([[119],{9713:(e,r,t)=>{t.d(r,{A:()=>i});var o=t(6070),a=t(9683),n=t(9970);function i({components:e,children:r,remarkPlugins:t,...i}){return(0,o.jsx)(a.o,{components:{h1:"h2",h2:"h3",...e},remarkPlugins:[n.A,...t??[]],...i,children:r})}},999:(e,r,t)=>{t.d(r,{A:()=>pe});var o=t(6070),a=t(918),n=t(9564),i=t(758),s=t(2620),l=t(4008);const c=(0,s.Ay)(l.A).attrs({forwardedAs:"a",defaultFilter:{disable:!0},activeFilter:{scale:7},hoverFilter:{animation:"alternating loop",scale:7}})`
...
`;var d=t(4977),h=t(7261);const u=["cubemap-blur","gltf-viewer"].map((e=>e.replaceAll("-"," "))),p=s.Ay.div`
    display: flex;
...
`,H=(0,s.Ay)(M).attrs({forwardedAs:"label"})`
    width: 100%;
...
`;function Y({children:e}){const r=(0,i.useId)(),t=(0,i.useRef)(null),a=(0,i.useRef)(null),[n,s]=(0,i.useState)(!0);return(0,o.jsx)(L(),{handle:`#${CSS.escape(r)}`,onDrag:()=>a.current?.refreshSeed(),bounds:"parent",nodeRef:t,children:(0,o.jsxs)(D,{ref:a,forwardedRef:t,children:[(0,o.jsx)(q,{id:r}),(0,o.jsxs)(X,{children:[(0,o.jsx)(H,{children:(0,o.jsx)("input",{type:"checkbox",style:{position:"absolute",top:-9999,left:-9999},onInput:()=>{s((e=>!e))},checked:n,readOnly:!0})}),(0,o.jsx)(G,{isOpen:n,overflowOnExpanded:!0,children:e})]})]})})}const U=(0,s.Ay)(M)`
    grid-column: span 3; 
    color: var(--accent-2); 
    --border-color: var(--accent-2);
`;function Q({settings:e}){return(0,o.jsxs)(Y,{children:[...Object.entries(e).map((([e,r])=>{const{[_.t.$type]:t,[_.t.$callback]:a,[_.t.$listeners]:n,...i}=r,s={...i,callbacks:n,label:e,onChange:e=>{r.value=e}};switch(r[_.t.$type]){case"button":return(0,o.jsx)(U,{...i,children:e});case"checkbox":return(0,o.jsx)(T,{...s});case"slider":return(0,o.jsx)(W,{...s});case"file":return(0,o.jsx)(N,{...s});default:throw new Error}}))]})}var J=t(4467);const K=(0,s.Ay)(l.A).attrs({forwardedAs:"button",defaultFilter:{scale:3},hoverFilter:{animation:"alternating loop",scale:7}})`
